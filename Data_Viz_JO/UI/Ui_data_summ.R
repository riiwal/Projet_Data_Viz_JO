...
tagList(
  navset_card_tab(
    ...
    #     column(
    #       4,
    #       selectInput( #Liste de choix pour l'affichage du summary
    #         "select_summary",
    #         "Choisissez une variable pour afficher sa description :",
    #         choices = list(
    #           "Population" = list(
    ...
    #     column(
    #       8,
    #         tableOutput("summary", height = 550)
    #     )
    #   )
    # ),
    nav_panel(title = "Données",
              fluidRow(DTOutput("table",height = 550)
                  )
                )
  )
)